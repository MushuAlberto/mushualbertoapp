  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-60 max-w-md mx-auto p-6 animate-fade-in w-full">
      <div className="flex items-center gap-2 mb-2">
        <Layers3 className="w-8 h-8 text-pink-700" />
        <h2 className="text-xl font-bold text-pink-800">Torre de Bloques</h2>
      ...
      <div className="mb-2 text-base text-center">
        Pronto deberás construir y recordar la secuencia de bloques.<br />
        <span className="text-xs text-gray-400">(¿Cuántos bloques recuerdas?)</span>
      </div>
      <div className="bg-pink-50 rounded-xl p-5 mt-3 mb-4 shadow border border-pink-200 flex flex-col items-center w-full">
        {/* Representación torre simple */}
        <div className="flex flex-col items-center gap-1 mb-2 min-h-[100px]">
          <div className="w-14 h-6 bg-pink-500 rounded" />
          <div className="w-10 h-6 bg-pink-400 rounded" />
          <div className="w-8 h-6 bg-pink-300 rounded" />
          <div className="w-6 h-6 bg-pink-200 rounded" />
        </div>
        <div className="text-gray-600 text-sm">¡Repite la secuencia más adelante!</div>
      </div>
      ...
      <div className="mt-4 text-xs text-gray-400 text-center">
        ¡Muy pronto podrás desafiar tu mente visual con torres y bloques cada vez más difíciles! (Nivel {level}/100)
      </div>
    </div>
  );
};

export default BlockTowerGame;
